import { HexString, VaultTypes, TransactionTypes } from '@nixjs23n6/utilities-adapter'

export abstract class BaseProvider {
    abstract getAccountFromMnemonic(derivationPath: number, mnemonic: string): Promise<VaultTypes.AccountObject>
