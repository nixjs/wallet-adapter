...
import { TransactionTypes, ProviderEnums, AssetTypes, VaultTypes, PrimitiveHexString } from '@nixjs23n6/utilities-adapter'
...
export abstract class BaseProvider {
    ...
    abstract getAddressExplorer(explorerURL: string, address: PrimitiveHexString, type: ProviderEnums.Network): string
    abstract getTransactionExplorer(explorerURL: string, address: PrimitiveHexString, type: ProviderEnums.Network): string
    ...
    abstract checkReceiveNFTStatus(chainId: string, address: PrimitiveHexString): Promise<boolean>
