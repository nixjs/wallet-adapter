...
import { SUIUtil, TransactionTypes, TransactionEnums, HexString, VaultTypes, PrimitiveHexString } from '@nixjs23n6/utilities-adapter'
...
export class QueryProvider {
    ...
    public async getOwnedObjects(address: PrimitiveHexString): Promise<SuiObject[]> {
    ...
    public async getOwnedCoins(address: PrimitiveHexString): Promise<SUIUtil.CoinObject[]> {
    ...
    public async getGasObject(address: PrimitiveHexString, gasBudget: number): Promise<SUIUtil.CoinObject | undefined> {
    ...
    public async getOwnedNfts(address: PrimitiveHexString): Promise<SUIUtil.NftObject[]> {
        const objects = await this.getOwnedObjects(address)
        const res = objects
            .map((item) => ({
                id: item.reference.objectId,
    ...
    public async getTransactionsForAddress(address: PrimitiveHexString): Promise<TransactionTypes.Transaction[]> {
