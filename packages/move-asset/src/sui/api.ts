...
export namespace SUIApiRequest {
    export async function getOwnedObjects(query: JsonRpcProvider, address: PrimitiveHexString): Promise<SuiObject[]> {
    ...
    export async function getOwnedCoins(query: JsonRpcProvider, address: PrimitiveHexString): Promise<SUIUtil.CoinObject[]> {
    ...
    export async function getCoinsBalance(nodeURL: string, address: PrimitiveHexString): Promise<AssetTypes.AssetAmount[]> {
